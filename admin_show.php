<?php include "admin_show_backend.php"?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
<body>
	...
	<div id="about" class="blueDiv">
		<center class="colorBlack">Show Information</center>
	</div>
	...
	<div class="adminForm">
		<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
			...
			<div class="gridColumnItem adminFormGap">
				<div class="gridRowItem">
					<span class="gridRowItem contactUsText colorBlack"> <?php echo $resultText;?></span>
				</div>
			</div>
		</form>
	</div>
